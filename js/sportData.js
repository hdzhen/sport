...
const sportData = {
    fitness: {
        ...
        fireFatPrimary: {
            items: [{
                action: "向后弓箭步", count: "12", content: "中心向后，身体垂直地面，前后脚弯曲90°，收腹", image: "img/sport/360.gif"
            }, {
                action: "体前屈", count: "12", content: "双手触耳，身体接近平行地面，收腹", image: "img/sport/361.gif"
            }, {
                action: "深蹲", count: "12", content: "呈后坐式", image: "img/sport/362.gif"
            }, {
                action: "开合跳", count: "20s", content: "轻盈跳，全程收紧腹部", image: "img/sport/363.gif"
            }, {
                action: "屈腿两头起", count: "12", content: "背部全程贴地，下巴微收，起身双手抱退1s", image: "img/sport/364.gif"
            }, {
                action: "简易俄罗斯转体", count: "12", content: "双脚触地，双手带动身体左右旋转", image: "img/sport/365.gif"
            }, {
                action: "仰卧举腿", count: "12", content: "背部全程贴地，双脚与腿呈90°，脚触地与收起呈90°", image: "img/sport/366.gif"
            }, {
                action: "四点支撑", count: "20s", content: "简易版平板支撑", image: "img/sport/367.gif"
            }, {
                action: "向前弓箭步", count: "12", content: "同向后弓箭步", image: "img/sport/368.gif"
            }, {
                action: "深蹲", count: "12", content: "呈后坐式", image: "img/sport/362.gif"
            }, {
                action: "侧移深蹲跳", count: "12", content: "深蹲向侧边来回跳起", image: "img/sport/369.gif"
            }, {
                action: "原地起跳", count: "12", content: "深蹲后跳起", image: "img/sport/370.gif"
            }, {
                action: "直腿两头起", count: "12", content: "腿交替抬起，与双手接触1s", image: "img/sport/371.gif"
            }, {
                action: "俄罗斯转体", count: "12", content: "双脚离地", image: "img/sport/372.gif"
            }, {
                action: "直腿抬起", count: "12", content: "背部贴地，双腿与地面呈90°，收腿抬背向上升", image: "img/sport/373.gif"
            }, {
                action: "四点支撑", count: "20s", content: "简易版平板支撑", image: "img/sport/367.gif"
            }]
        }, fireFatIntermediate: {
            items: [{
                action: "勾腿跳", count: "20s", content: "原地跳", image: "img/sport/351.gif"
            }, {
                action: "深蹲", count: "12", content: "身直，后坐式", image: "img/sport/352.gif"
            }, {
                action: "改良版仰卧起坐", count: "12", content: "盘腿，脚掌贴合", image: "img/sport/353.gif"
            }, {
                action: "俯卧撑", count: "12", content: "标准，慢速", image: "img/sport/331.gif"
            }, {
                action: "平板支撑开合跳", count: "20s", content: "收紧核心，双脚开合跳", image: "img/sport/355.gif"
            }, {
                action: "波比跳", count: "12", content: "坚持", image: "img/sport/356.gif"
            }, {
                action: "单杠悬垂", count: "10S", content: "坚持", image: "img/sport/341.gif"
            }], tips: "↑ 重复三遍"
        }, abdominalExercise: {
            items: [{
                action: "摸膝卷腹",
